...
public class CircularContact extends ViewSwitcher
  {
  ...
  public CircularContact(final Context context)
    {
    this(context,null);
    }

  @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
  public CircularContact(final Context context,final AttributeSet attrs)
    {
    super(context,attrs);
