...
public class MaterialCalendarView extends FrameLayout {
    ...
    private final MonthView.Callbacks monthViewCallbacks = new MonthView.Callbacks() {
        @Override
        public void onDateChanged(CalendarDay date, DayView dayView) {
            setSelectedDate(date);

            if(listener != null) {
                listener.onDateChanged(MaterialCalendarView.this, date, dayView);
            }
        }
    };
        ...
        public void setRangeDates(CalendarDay min, CalendarDay max) {
            ...
            if(prevDate != null) {
                if(!prevDate.equals(selectedDate)) {
                    callbacks.onDateChanged(selectedDate, null);
                }
            }
        }
